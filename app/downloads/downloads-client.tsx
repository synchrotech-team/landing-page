...
export default function DownloadsPageClient() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased selection:bg-purple-electric selection:text-white">
      <div className="relative z-10">
        ...
        <section className="pt-16 pb-12 border-b border-foreground/5 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 text-center space-y-6 relative z-10">
            ...
            <h1 className="font-display text-4xl sm:text-6xl font-extrabold uppercase tracking-tight text-foreground max-w-4xl mx-auto leading-tight">
              {lang === 'en' ? (
        ...
        <section className="py-16 max-w-7xl mx-auto px-4 md:px-8 space-y-12">
          {loading ? (
            ...
            <div className="bg-surface border border-purple-electric/30 p-12 text-center space-y-6">
              <div className="w-16 h-16 bg-purple-electric/10 border border-purple-electric/30 flex items-center justify-center text-purple-electric mx-auto">
                <HardDrive size={32} />
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {archivedReleases.map((rel) => (
                  <div key={rel.id} className="p-6 rounded-2xl bg-surface border border-foreground/10 space-y-4 hover:border-purple-electric/40 transition-all">
                    <div className="flex justify-between items-center">
                      <span className="px-3 py-0.5 rounded-full text-xs font-mono font-bold bg-foreground/10 text-foreground border border-foreground/15">
                        {rel.version}
                      </span>
                    ...
                    <div>
                      <h4 className="font-bold text-foreground text-base">{rel.fileName}</h4>
